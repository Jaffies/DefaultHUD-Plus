...
hook.Add("PopulateToolMenu", "DFHUDPopulate", function() // Наполняем менюшку
	spawnmenu.AddToolMenuOption("Options", "DefaultHUDMenu", "DFHUDOptions", GetPhrase("dfhud.options", "Options"), "", "", function(panel)
		...
		panel:CheckBox(GetPhrase("dfhud.blur", "Enable blur"), "dfhud_blur")
		panel:NumSlider(GetPhrase("dfhud.blur.power", "Blur power"), "dfhud_blur_power", 1, 15, false)
		panel:ControlHelp(GetPhrase("dfhud.fpswarn", "Blur can cause performance issues."))
